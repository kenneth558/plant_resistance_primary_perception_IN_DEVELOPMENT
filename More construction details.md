...
Below is a sopy-pasteable, spreadsheet-compatible price tracking version of the parts list for you to compare prices when you do your ordering.  Try just selecting the whole thing at once and copying into a spreadsheet sheet while the entire empty spreadsheet sheet is selected:
