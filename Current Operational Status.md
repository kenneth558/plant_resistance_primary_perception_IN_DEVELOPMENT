...
My advice is to only parallel 25 devices together - leave an empty footprint, either U8 or one of them on the flex board.  You can always add the last dPot if you find out later that your DUTs are very low conductance and not too active.
