...
2. Under shields that are used or can be used in any sense for hermetic sealing, try to place all vias within pads so that they get solder-sealed when components are placed.
