...
F 5 "SJ1-3523NG" H 1500 2375 50  0001 C CNN "Part_number"
...
F 6 "00 Place (always means solder herein), then check work for inadvertent shorts and opens" H 10100 -1675 50  0001 C CNN "ClickToSortForPlacement"
...
F 5 "part of first 9-146282-0" H 21350 1500 50  0001 C CNN "Part_number"
...
F 5 "part of first 9-146282-0" H 21850 2500 50  0001 C CNN "Part_number"
...
F 7 "VN2106N3-G or DMN601K-7" H 21800 9572 50  0001 C CNN "Part_number"
...
F 5 "part of first 9-146282-0" H 21250 2400 50  0001 C CNN "Part_number"
...
F 5 "03" H 13950 6822 50  0001 C CNN "SortForPlacement"
F 6 "06 Then check work for inadvertent shorts and opens" H 13950 6822 50  0001 C CNN "ClickToSortForPlacement"
F 7 "VN2106N3-G or DMN601K-7" H 20900 9572 50  0001 C CNN "Part_number"
...
F 6 "00 Place (always means solder herein), then check work for inadvertent shorts and opens" H 12800 2350 50  0001 C CNN "ClickToSortForPlacement"
	2    12800 2350
	1    0    0    -1  
$EndComp
$Comp
...
F 4 "00 !Assembly instructions  not complete - do not trust this yet for assembly order!" H 15250 3075 50  0001 C CNN "ClickToSortForPlacement"
F 5 "n/a" H 15250 3075 50  0001 C CNN "Part_number"
F 6 "n/a" H 15250 3075 50  0001 C CNN "Source"
	1    15250 3075
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 6 "00 Place (always means solder herein), then check work for inadvertent shorts and opens" H 12800 1725 50  0001 C CNN "ClickToSortForPlacement"
	1    12800 1725
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 4 "part of MSB-T plus part of a second 9-146282-0" H 9275 1800 50  0001 C CNN "Part_number"
...
F 7 "VN2106N3-G or DMN601K-7" H 19025 9575 50  0001 C CNN "Part_number"
...
F 7 "VN2106N3-G or DMN601K-7" H 19825 9575 50  0001 C CNN "Part_number"
...
F 7 "VN2106N3-G or DMN601K-7" H 20500 9575 50  0001 C CNN "Part_number"
...
Wire Wire Line
	18825 9575 18825 6250
Wire Wire Line
	18825 6250 6200 6250
Wire Wire Line
	6200 6250 6200 2525
Wire Wire Line
...
F 6 "00 Place (always means solder herein), then check work for inadvertent shorts and opens" H 3450 1650 50  0001 C CNN "ClickToSortForPlacement"
	3    3450 1650
	-1   0    0    1   
$EndComp
Wire Wire Line
...
F 4 "part of MSB-T plus part of a second 9-146282-0" H 2825 1750 50  0001 C CNN "Part_number"
	1    2825 1750
	1    0    0    -1  
$EndComp
$Comp
...
F 4 "part of MSB-T plus part of a second 9-146282-0" H 4200 1300 50  0001 C CNN "Part_number"
	1    4200 1300
	-1   0    0    -1  
$EndComp
$Comp
...
U 1 1 5DC91543
P 21025 5625
F 0 "#PWR030" H 21025 5375 50  0001 C CNN
F 1 "GNDD" H 21029 5470 50  0000 C CNN
F 2 "" H 21025 5625 50  0001 C CNN
F 3 "" H 21025 5625 50  0001 C CNN
	1    21025 5625
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5DC922E1
P 21025 5325
F 0 "#PWR029" H 21025 5175 50  0001 C CNN
F 1 "VCC" H 21042 5498 50  0000 C CNN
F 2 "" H 21025 5325 50  0001 C CNN
F 3 "" H 21025 5325 50  0001 C CNN
	1    21025 5325
	1    0    0    -1  
$EndComp
Text Notes 21425 5900 0    50   ~ 0
Developer-user 2
Text Notes 20600 5900 0    50   ~ 0
Developer-user 1
Text Notes 17375 6175 0    50   ~ 0
If using the UNO SMD MCU version with an ATMEGA128P-AU (a \nTQFP package specifically instead of the UNO with a DIP \nATMEGA128P), there are two analog input pins available at the \nTQFP package on the MCU board that not wired out to any \nconnector.  Their TQFP pin numbers are 19 (A6) and 22 (A7).\n\nOne or both of these can be, if you are willing to attach \ntiny wires to them and write the code, used as seventh and \neighth analog inputs, again, A6 & A7.  Then air-wire them or \nconnectorize them somehow with a J6 across to this extention \nboard and buy the PCB mount vertically oriented version of \nPTV09 pots to get one or two more user developed, run-time \nanalog input controls into the training board.
...
F 5 "part of first 9-146282-0" H 21700 1500 50  0001 C CNN "Part_number"
...
U 1 1 5CFC1705
P 20125 5575
F 0 "J6" H 20017 5150 50  0000 C CNN
F 1 "Conn_01x04_Female" H 20017 5241 50  0000 C CNN
F 2 "multipackage:FFC_2x02_P2.00mm_Vertical" H 20125 5575 50  0001 C CNN
F 3 "~" H 20125 5575 50  0001 C CNN
F 4 "PCB-C-04-T-20" H 20125 5575 50  0001 C CNN "Part_number"
F 5 "http://Arrow.com" H 20125 5575 50  0001 C CNN "Source"
	1    20125 5575
	-1   0    0    1   
$EndComp
Wire Wire Line
	20875 5475 20775 5475
Wire Wire Line
	21575 5475 21500 5475
Wire Wire Line
	21500 4975 20775 4975
Wire Wire Line
	20775 4975 20775 5350
Wire Wire Line
	20775 5350 20500 5350
Wire Wire Line
	20325 5350 20325 5375
Connection ~ 20325 5375
Wire Wire Line
	20325 5375 20325 5475
Wire Wire Line
	20325 5575 20775 5575
Wire Wire Line
	20775 5475 20775 5575
Connection ~ 20325 5575
Wire Wire Line
	20325 5575 20325 5675
Wire Wire Line
...
Text Label 20500 5450 0    60   ~ 0
A7
Text Label 20325 5825 0    60   ~ 0
A6
Wire Wire Line
	20325 5825 20325 5675
Connection ~ 20325 5675
Wire Wire Line
	20500 5450 20500 5350
Connection ~ 20500 5350
Wire Wire Line
	20500 5350 20325 5350
Wire Wire Line
