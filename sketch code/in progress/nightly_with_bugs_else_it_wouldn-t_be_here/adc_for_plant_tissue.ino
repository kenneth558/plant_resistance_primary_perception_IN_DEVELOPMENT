...
int32_t oneReadingFromThisOutboardADC( uint8_t whichOutboardADCindex )
{
  ...
  //                                            hx711.power_up();
  //  hx711.set_gain( "in here belongs a means of reading a designated, otherwise unused Analog Input pin and determining which gain of 32, 64, or 128 is being called for.  This allows an operator-controlled potentiometer to change the gain during run-time to prevent a re-compile as being the only means of setting the gain" );
