...
#define HIGHEST_SENSI_PGA_GAIN_FACTOR 64                                    //PGA=Programmable Gain Amplifier: many ADCs will correlate a gain of one with full-scale being rail-to-rail, while a gain of anything higher correlates to full-scale being in the mV range (most sensitive and most noise-susceptible).  Set of allowable values channel A: 64 and 128.  Channel B is fixed at 32
...
********************************************************************************
   Changelog:  21 Jan   2019 :  Reversed the order of traces plotted so that the outboard ADC is in the top group.
