...
Here is the link to the main board at OSH Park all ready to order without having to upload files:
https://oshpark.com/shared_projects/uDuDnUHi
...
Here is the link to the aux board at OSH Park all ready to order without having to upload files:
